...
:func:`kkoclaw.runtime.serialization.serialize_channel_values` to
...
from kkoclaw.config.paths import Paths, get_paths
from kkoclaw.runtime import serialize_channel_values
from kkoclaw.runtime.user_context import get_effective_user_id
from kkoclaw.utils.time import coerce_iso, now_iso
...
class ThreadSearchRequest(BaseModel):
    ...
    def _validate_metadata_filters(cls, v: dict[str, Any]) -> dict[str, Any]:
        ...
        See ``kkoclaw.persistence.json_compat`` for the shared validators.
        """
        if not v:
            return v
        from kkoclaw.persistence.json_compat import validate_metadata_filter_key, validate_metadata_filter_value
...
async def search_threads(body: ThreadSearchRequest, request: Request) -> list[ThreadResponse]:
    ...
    from kkoclaw.persistence.thread_meta import InvalidMetadataFilterError
...
async def get_thread_history(thread_id: str, body: ThreadHistoryRequest, request: Request) -> list[HistoryEntry]:
    ...
    :func:`~kkoclaw.runtime.serialization.serialize_channel_values`.
