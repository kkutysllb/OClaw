...
OClaw 是一个基于 LangGraph 的 AI 超级智能体系统，具有沙箱执行、持久记忆和可扩展工具集成能力。后端使 AI 智能体能够在隔离的 per-thread 环境中执行代码、浏览网页、管理文件、委派任务给子智能体，并跨会话保留上下文。
