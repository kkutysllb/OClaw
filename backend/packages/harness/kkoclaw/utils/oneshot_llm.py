...
from kkoclaw.tracing import inject_langfuse_metadata
from kkoclaw.utils.llm_text import extract_response_text


def _resolve_environment() -> str | None:
    return os.environ.get("KK_OCLAW_ENV") or os.environ.get("ENVIRONMENT")
