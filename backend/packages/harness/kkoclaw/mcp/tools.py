    ...
    *,
    ...
    async def call_with_persistent_session(
        ...
        **arguments: Any,
        ...
        session = await pool.get_session(server_name, thread_id, connection, user_id=user_id)
...
async def get_mcp_tools(
    ...
    *,
    ...
    try:
        ...
        # pooling them causes RuntimeError on cleanup.
        ...
        for tool in tools:
            ...
            if tool_server is not None:
                ...
                if transport == "stdio":
                    wrapped_tools.append(_make_session_pool_tool(tool, tool_server, servers_config[tool_server], tool_interceptors, user_id=user_id))
                else:
