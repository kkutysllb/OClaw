 ...
 *
 * `~/.kkoclaw-desktop/skills/` contains bundled `builtin/` skills (seeded on
 ...
 * `task/`, and `coding/` grouping skills by work mode.
 */
...
/**
 * The bundled built-in skill sub-roots (core/task/coding).
 *
 * Returns the paths to `builtin/core`, `builtin/task`, `builtin/coding`
 * inside the bundled skills directory. Falls back to the legacy flat
 * `public/` directory if the new layout is not present.
 *
