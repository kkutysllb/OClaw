...
1. Start OClaw locally using any working development setup you already use.
   ...
   If you already have OClaw running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.kkoclaw/memory.json`
