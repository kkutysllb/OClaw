...
感谢你对 OClaw 的关注！本文档将帮助你搭建开发环境并了解开发工作流程。
...
| `make docker-start` 审查环境 | 4 vCPU、8 GB 内存 | 8 vCPU、16 GB 内存 | Docker 镜像构建需要更多空间。 |
| 共享 Linux 测试服务器 | 8 vCPU、16 GB 内存 | 16 vCPU、32 GB 内存 | 适合较重度的多 agent 运行或多审查者场景。 |

`2 vCPU / 4 GB` 的环境通常无法可靠启动，或在正常 OClaw 负载下变得无响应。
...
- 查看已有的 [Issues](https://github.com/OClaw/kkoclaw/issues)
- 阅读[文档](backend/docs/)
- 在[讨论区](https://github.com/OClaw/kkoclaw/discussions)提问

## 许可证

向 OClaw 贡献代码，即表示你同意你的贡献将按照 [MIT 许可证](./LICENSE) 进行许可。
