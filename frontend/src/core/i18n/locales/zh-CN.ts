...
export const zhCN: Translations = {
  ...
  inputBox: {
    ...
    workspaceDefaultDescription: "用户数据目录 (~/.kkoclaw)",
  ...
  workModes: {
    ...
    coding: {
      name: "编程",
      description: "编程助手，适用于代码编写、调试与项目开发任务",
    },
  },
  ...
  settings: {
    ...
    import: {
      title: "从 Web 端导入数据",
      description:
        "将 Web 端 OClaw 项目中的自定义技能、配置、凭证和记忆迁移到桌面端的私有目录。Web 端的公共技能迁移后将变为桌面端的私有副本，可自由修改。",
      openWizard: "打开迁移向导",
      autoPromptTitle: "检测到 Web 端项目",
      autoPromptDescription:
        "检测到本机已部署 Web 端 OClaw 项目。是否将其技能、配置和记忆迁移到桌面端？",
      autoPromptImport: "立即导入",
      autoPromptLater: "稍后再说",
      wizard: {
        title: "数据迁移向导",
        step: "步骤",
        stepSource: "选择来源",
        ...
        selectAll: "全选",
        selectNone: "全不选",
        sourceLabel: "Web 端项目路径",
        sourcePlaceholder: "选择 Web 端 OClaw 项目根目录",
        sourceDetected: "检测到的项目",
        sourceManual: "手动指定路径",
        sourceEmpty: "未检测到可迁移的数据源",
        scanning: "正在扫描...",
        categorySkills: "自定义技能",
        categoryExtensions: "扩展配置",
        categoryCredentials: "技能凭证",
        categoryMemory: "记忆数据",
        categoryAgents: "自定义 Agent",
        previewCopy: "将复制",
        previewMerge: "将合并",
        previewSkip: "已存在，跳过",
        previewSummary: "摘要",
        ...
        executeDone: "迁移完成",
        executeError: "迁移失败",
        restartHint: "建议重启应用以加载迁移后的配置和技能。",
      },
    },
    memory: {
      title: "记忆",
