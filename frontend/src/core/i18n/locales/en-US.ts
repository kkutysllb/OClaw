...
export const enUS: Translations = {
  ...
  inputBox: {
    ...
    workspaceDefaultDescription: "User data directory (~/.kkoclaw)",
  ...
  workModes: {
    ...
    // Legacy alias kept for threads created before the task/coding split.
    office: {
      name: "Office",
      description:
    ...
    coding: {
      name: "Coding",
      description:
        "Coding assistant for writing, debugging, and shipping software projects",
    },
  },
  ...
  settings: {
    ...
    import: {
      title: "Import from Web Deployment",
      description:
        "Migrate custom skills, configuration, credentials and memory from an existing web deployment of OClaw into the desktop app. Shared skills on the web side become private copies on the desktop.",
      openWizard: "Open Migration Wizard",
      autoPromptTitle: "Web deployment detected",
      autoPromptDescription:
        "An existing OClaw web deployment was detected on this machine. Import its skills, config and memory now?",
      autoPromptImport: "Import now",
      autoPromptLater: "Later",
      wizard: {
        title: "Data Migration Wizard",
        step: "Step",
        stepSource: "Select Source",
        stepContent: "Choose Content",
        stepPreview: "Preview",
        stepExecute: "Execute",
        next: "Next",
        back: "Back",
        ...
        sourceLabel: "Web project path",
        sourcePlaceholder: "Select the web project root to migrate from",
        sourceDetected: "Detected projects",
        sourceManual: "Choose a path manually",
        sourceEmpty: "No migratable source detected",
        scanning: "Scanning...",
        categorySkills: "Custom skills",
        categoryExtensions: "Extension config",
        categoryCredentials: "Skill credentials",
        categoryMemory: "Memory data",
        categoryAgents: "Custom agents",
        previewCopy: "Will copy",
        previewMerge: "Will merge",
        previewSkip: "exists, skip",
        previewSummary: "Summary",
        executing: "Migrating...",
        executeDone: "Migration complete",
        executeError: "Migration failed",
        restartHint:
          "Please restart the app to load the migrated configuration and skills.",
      },
    },
    memory: {
      title: "Memory",
